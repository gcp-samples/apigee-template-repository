...
| Template | Description | Colab Notebook |
|---|---|---|
| **[`REST-AI-Messages.yaml`](templates/REST-AI-Messages.yaml)** | Anthropic Claude Messages API proxy providing native `/v1/messages` protocol support with routing between Anthropic API and Google Cloud Vertex AI.<br/><br/>**Features:** [`ai-endpoint-messages`](features/ai-endpoint-messages.yaml), [`ai-target-googlecloud`](features/ai-target-googlecloud.yaml), [`ai-model-preprocess`](features/ai-model-preprocess.yaml), [`ai-model-postprocess`](features/ai-model-postprocess.yaml) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gcp-samples/apigee-template-repository/blob/main/notebooks/REST-AI-Messages.ipynb) |
...
| **[`REST-AI-Embeddings.yaml`](templates/REST-AI-Embeddings.yaml)** | OAI vector embeddings generation API proxy providing unified text embedding endpoints across OpenAI and Google Cloud Vertex AI embedding models.<br/><br/>**Features:** [`ai-endpoint-embeddings`](features/ai-endpoint-embeddings.yaml), [`ai-model-routing`](features/ai-model-routing.yaml), [`ai-target-openai`](features/ai-target-openai.yaml), [`ai-target-googlecloud`](features/ai-target-googlecloud.yaml), [`ai-model-analytics`](features/ai-model-analytics.yaml), [`auth-apikey-validate`](features/auth-apikey-validate.yaml) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gcp-samples/apigee-template-repository/blob/main/notebooks/REST-AI-Embeddings.ipynb) |
| **[`REST-AI-Images.yaml`](templates/REST-AI-Images.yaml)** | OAI image generation and editing API proxy routing image creation prompts to OpenAI DALL-E and Google Cloud Imagen targets.<br/><br/>**Features:** [`ai-endpoint-images`](features/ai-endpoint-images.yaml), [`ai-model-routing`](features/ai-model-routing.yaml), [`ai-target-openai`](features/ai-target-openai.yaml), [`ai-target-googlecloud`](features/ai-target-googlecloud.yaml), [`ai-model-analytics`](features/ai-model-analytics.yaml), [`auth-apikey-validate`](features/auth-apikey-validate.yaml) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gcp-samples/apigee-template-repository/blob/main/notebooks/REST-AI-Images.ipynb) |
| **[`REST-AI-Models.yaml`](templates/REST-AI-Models.yaml)** | OAI Unified AI model catalogue and discovery API proxy aggregating available models across Google Cloud Vertex AI, OpenAI, and Anthropic.<br/><br/>**Features:** [`ai-endpoint-models`](features/ai-endpoint-models.yaml), [`ai-model-routing`](features/ai-model-routing.yaml), [`ai-target-openai`](features/ai-target-openai.yaml), [`ai-target-googlecloud`](features/ai-target-googlecloud.yaml), [`ai-target-gemini`](features/ai-target-gemini.yaml), [`auth-apikey-validate`](features/auth-apikey-validate.yaml) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gcp-samples/apigee-template-repository/blob/main/notebooks/REST-AI-Models.ipynb) |
---
