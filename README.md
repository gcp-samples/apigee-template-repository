...
```bash
# Clone repository
git clone https://github.com/gcp-samples/apigee-template-repository.git
cd apigee-template-repository
...
#### Google Protocols
| Template | Description | Colab Notebook |
|---|---|---|
| **[`REST-AI-Interactions.yaml`](templates/REST-AI-Interactions.yaml)** | Gemini interactions API proxy supporting multi-turn conversational agents, session state management, model routing and checks, and token usage analytics.<br/><br/>**Features:** [`ai-endpoint-interactions`](features/ai-endpoint-interactions.yaml), [`ai-target-gemini`](features/ai-target-gemini.yaml), [`ai-model-preprocess`](features/ai-model-preprocess.yaml), [`ai-model-postprocess`](features/ai-model-postprocess.yaml) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gcp-samples/apigee-template-repository/blob/main/notebooks/REST-AI-Interactions.ipynb) |
| **[`REST-AI-GenerateContent.yaml`](templates/REST-AI-GenerateContent.yaml)** | Google Cloud Vertex AI and Gemini generateContent API proxy supporting multimodal inputs, streaming responses, model routing and checks, failover, and token usage analytics.<br/><br/>**Features:** [`ai-endpoint-content`](features/ai-endpoint-content.yaml), [`ai-target-googlecloud`](features/ai-target-googlecloud.yaml), [`ai-model-preprocess`](features/ai-model-preprocess.yaml), [`ai-model-failover`](features/ai-model-failover.yaml), [`ai-model-postprocess`](features/ai-model-postprocess.yaml) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gcp-samples/apigee-template-repository/blob/main/notebooks/REST-AI-GenerateContent.ipynb) |

#### Anthropic Protocols
| Template | Description | Colab Notebook |
|---|---|---|
| **[`REST-AI-Messages.yaml`](templates/REST-AI-Messages.yaml)** | Anthropic Claude Messages API proxy providing native `/v1/messages` protocol support with routing to Google Cloud Vertex AI Model Garden, model checks, streaming, and token usage analytics.<br/><br/>**Features:** [`ai-endpoint-messages`](features/ai-endpoint-messages.yaml), [`ai-target-googlecloud`](features/ai-target-googlecloud.yaml), [`ai-model-preprocess`](features/ai-model-preprocess.yaml), [`ai-model-postprocess`](features/ai-model-postprocess.yaml) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gcp-samples/apigee-template-repository/blob/main/notebooks/REST-AI-Messages.ipynb) |

#### OAI Protocols
| Template | Description | Colab Notebook |
|---|---|---|
| **[`REST-AI-Completions.yaml`](templates/REST-AI-Completions.yaml)** | OAI Multi-provider Chat Completions API proxy supporting OpenAI, Google Cloud, and Anthropic targets with intelligent model routing, failover, token counting, and API key validation.<br/><br/>**Features:** [`ai-endpoint-completions`](features/ai-endpoint-completions.yaml), [`ai-target-googlecloud`](features/ai-target-googlecloud.yaml), [`ai-model-preprocess`](features/ai-model-preprocess.yaml), [`auth-apikey-verify`](features/auth-apikey-verify.yaml), [`ai-model-failover`](features/ai-model-failover.yaml), [`ai-model-postprocess`](features/ai-model-postprocess.yaml), [`ai-token-quota`](features/ai-token-quota.yaml) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gcp-samples/apigee-template-repository/blob/main/notebooks/REST-AI-Completions.ipynb) |
| **[`REST-AI-Embeddings.yaml`](templates/REST-AI-Embeddings.yaml)** | OAI vector embeddings generation API proxy providing unified text embedding endpoints across OpenAI and Google Cloud Vertex AI embedding models with automated format mediation and token usage analytics.<br/><br/>**Features:** [`ai-endpoint-embeddings`](features/ai-endpoint-embeddings.yaml), [`ai-target-googlecloud`](features/ai-target-googlecloud.yaml), [`ai-target-openai`](features/ai-target-openai.yaml), [`ai-model-preprocess`](features/ai-model-preprocess.yaml), [`ai-model-postprocess`](features/ai-model-postprocess.yaml) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gcp-samples/apigee-template-repository/blob/main/notebooks/REST-AI-Embeddings.ipynb) |
| **[`REST-AI-Images.yaml`](templates/REST-AI-Images.yaml)** | OAI image generation and editing API proxy routing image creation prompts to OpenAI DALL-E and Google Cloud Imagen targets with automated format mediation and response normalization.<br/><br/>**Features:** [`ai-endpoint-images-generations`](features/ai-endpoint-images-generations.yaml), [`ai-target-googlecloud`](features/ai-target-googlecloud.yaml), [`ai-target-openai`](features/ai-target-openai.yaml), [`ai-model-preprocess`](features/ai-model-preprocess.yaml), [`ai-model-postprocess`](features/ai-model-postprocess.yaml) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/gcp-samples/apigee-template-repository/blob/main/notebooks/REST-AI-Images.ipynb) |

---

## Stable Features

Modular feature extensions referenced by the stable templates. Each feature provides reusable API proxy capabilities including endpoints, target routings, policy chains, and protocol mediations.

| Feature | Description | Documentation |
|---|---|---|
| **[`ai-endpoint-interactions.yaml`](features/ai-endpoint-interactions.yaml)** | Google Gemini interactions API endpoint (`/v1/interactions`) supporting conversational session management and multi-turn chat flows. | [View Docs](https://gcp-samples.github.io/apigee-template-repository/docs/?file=features/ai-endpoint-interactions.yaml) |
| **[`ai-endpoint-content.yaml`](features/ai-endpoint-content.yaml)** | Google Cloud Vertex AI and Gemini generateContent API endpoint (`/v1beta/models/{model}:generateContent`) supporting multimodal and streaming generation. | [View Docs](https://gcp-samples.github.io/apigee-template-repository/docs/?file=features/ai-endpoint-content.yaml) |
| **[`ai-endpoint-messages.yaml`](features/ai-endpoint-messages.yaml)** | Anthropic Messages API endpoint (`/v1/messages`) supporting standard Claude message payloads and streaming SSE responses. | [View Docs](https://gcp-samples.github.io/apigee-template-repository/docs/?file=features/ai-endpoint-messages.yaml) |
| **[`ai-endpoint-completions.yaml`](features/ai-endpoint-completions.yaml)** | OpenAI Chat Completions API endpoint (`/v1/chat/completions`) with OpenAPI specification validation and pre-flow execution hooks. | [View Docs](https://gcp-samples.github.io/apigee-template-repository/docs/?file=features/ai-endpoint-completions.yaml) |
| **[`ai-endpoint-embeddings.yaml`](features/ai-endpoint-embeddings.yaml)** | OpenAI-compatible vector embeddings API endpoint (`/v1/embeddings`) supporting text vectorization and batch embedding inputs. | [View Docs](https://gcp-samples.github.io/apigee-template-repository/docs/?file=features/ai-endpoint-embeddings.yaml) |
| **[`ai-endpoint-images-generations.yaml`](features/ai-endpoint-images-generations.yaml)** | OpenAI-compatible image generations API endpoint (`/v1/images/generations`) supporting prompt-to-image synthesis and parameter mapping. | [View Docs](https://gcp-samples.github.io/apigee-template-repository/docs/?file=features/ai-endpoint-images-generations.yaml) |
| **[`ai-target-gemini.yaml`](features/ai-target-gemini.yaml)** | Upstream target connection routing to Google Gemini Developer API endpoints (`generativelanguage.googleapis.com`) with API key injection. | [View Docs](https://gcp-samples.github.io/apigee-template-repository/docs/?file=features/ai-target-gemini.yaml) |
| **[`ai-target-googlecloud.yaml`](features/ai-target-googlecloud.yaml)** | Upstream target connection routing to Google Cloud Vertex AI Model Garden endpoints (`aiplatform.googleapis.com`) with automated OAuth token attachment. | [View Docs](https://gcp-samples.github.io/apigee-template-repository/docs/?file=features/ai-target-googlecloud.yaml) |
| **[`ai-target-openai.yaml`](features/ai-target-openai.yaml)** | Upstream target connection routing to OpenAI API endpoints (`api.openai.com`) with authorization header forwarding. | [View Docs](https://gcp-samples.github.io/apigee-template-repository/docs/?file=features/ai-target-openai.yaml) |
| **[`ai-model-preprocess.yaml`](features/ai-model-preprocess.yaml)** | Comprehensive pre-flight mediation feature handling request normalization, provider routing, model alias mapping, prompt extraction, and cross-provider payload conversions. | [View Docs](https://gcp-samples.github.io/apigee-template-repository/docs/?file=features/ai-model-preprocess.yaml) |
| **[`ai-model-postprocess.yaml`](features/ai-model-postprocess.yaml)** | Response normalization and analytics collection feature standardizing model outputs and logging token consumption into Apigee Data Collectors. | [View Docs](https://gcp-samples.github.io/apigee-template-repository/docs/?file=features/ai-model-postprocess.yaml) |
| **[`ai-model-failover.yaml`](features/ai-model-failover.yaml)** | Dynamic upstream failover and circuit breaker feature automatically retrying secondary models or alternative providers upon 429 or 5xx upstream errors. | [View Docs](https://gcp-samples.github.io/apigee-template-repository/docs/?file=features/ai-model-failover.yaml) |
| **[`auth-apikey-verify.yaml`](features/auth-apikey-verify.yaml)** | Security verification feature validating consumer API keys against Apigee API Products and developer applications (`VerifyAPIKey`). | [View Docs](https://gcp-samples.github.io/apigee-template-repository/docs/?file=features/auth-apikey-verify.yaml) |
| **[`ai-token-quota.yaml`](features/ai-token-quota.yaml)** | Quota enforcement and rate-limiting policy governing model access and token consumption thresholds across developer tiers. | [View Docs](https://gcp-samples.github.io/apigee-template-repository/docs/?file=features/ai-token-quota.yaml) |
